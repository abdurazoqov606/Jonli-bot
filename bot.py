...
def cmd_start(message):
    ...
    # 🟢 Telegram ichida (Mini App) ochiladigan yorqin tugma
    ...
    text = (
        ...
        "🇺🇿 O'zbekistondagi va 🌍 Butun dunyo telekanallarini tekin tomosha qiling!\n\n"
        "<i>👇 Quyidagi tugmani bosib, bevosita Telegram ichida tomoshani boshlang:</i>"
    )
